...
class ClientmachineSubmit extends StatefulWidget {
  const ClientmachineSubmit({super.key});
...
class _MachineInspectionRequestPageState extends State<ClientmachineSubmit>
