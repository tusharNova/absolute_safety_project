...
class Clientcertificatestatushistorypage extends StatefulWidget {
  const Clientcertificatestatushistorypage({super.key});
...
class _CertificateStatusHistoryPageState
    extends State<Clientcertificatestatushistorypage>
