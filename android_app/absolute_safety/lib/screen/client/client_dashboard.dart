import 'package:absolute_safety/screen/client/dashboard/ClientCertificateStatusHistoryPage.dart';
import 'package:absolute_safety/screen/client/dashboard/ClientDownloadCertificatePage.dart';
import 'package:absolute_safety/screen/client/dashboard/ClientRenewalRemindersPage.dart';
import 'package:absolute_safety/screen/client/dashboard/ClientScanQRCodePage.dart';
import 'package:absolute_safety/screen/client/dashboard/Clientmachine_submit.dart';
...
class _DashboardScreenState extends State<ClientDashboard>
  ...
  Widget _buildDashboardOptions() {
    final options = [
      ...
      },
      {
        ...
        'route': Clientcertificatestatushistorypage(),
      },
      {
        ...
        'route': Clientrenewalreminderspage(),
      ...
      },
      {
        ...
        'route': Clientdownloadcertificatepage(),
      },
      {
        'title': 'Scan QR Code',
