...
<head>
    ...
    <!-- Page CSS -->
    <!-- Font Awesome CDN (v6) -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" integrity="sha512-ZG+9DJYXEc2Tu4V+6ZlKCGN2O/XBq2U3CTr6Oc7TIpAKF6QJ1Vj8QpPa+2kMeDGwOvQxk9AmJXYTf6u5tzq5BQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
                ...
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img src="../assets/img/absolute-safety-logo.jpeg" style=" height: 55px; width: auto;">
                        </span>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-lg-8 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">Hoist Inspection Summary 🏗️</h5>
                                                <p class="mb-4">
                                                    Last inspection completed on <span class="fw-bold">26.05.2025</span>. Next inspection due by <span class="fw-bold">25.11.2025</span>.
                                                </p>
                            ...
                            <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                                <div class="card">
                                    <h5 class="card-header">ALBISO SC200 Hoist Specifications</h5>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="mb-2"><strong>Serial No:</strong> 20250502</li>
                                                    <li class="mb-2"><strong>Maximum Capacity:</strong> 2 ton (1600kg SWL)</li>
                                                    <li class="mb-2"><strong>Current Height:</strong> 60 meters</li>
                                                </ul>
                                            </div>
                                            <div class="col-md-6">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="mb-2"><strong>Manufacture Date:</strong> 01/2025</li>
                                                    <li class="mb-2"><strong>Safety Lock No:</strong> 01398355</li>
                                                    <li class="mb-2"><strong>Certificate Valid Until:</strong> 01/2030</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="mt-3">
                                            <div class="alert alert-success">
                                                ...
                                                <p class="mb-0">All critical components checked and found satisfactory. Preventive drop safety device working properly.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="alert alert-warning">
                                                <i class="bx bx-calendar-exclamation"></i> 26.11.2025 (6 months from last inspection)
                                            </div>
                                        </div>
                                        <div>
                                        ...
                                        <ul class="p-0 m-0">
                                            <li class="d-flex mb-4 pb-1">
                                                ...
                                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="badge bg-label-success rounded-pill">OK</div>
                                                </div>
                                            </li>
                                            <li class="d-flex mb-4 pb-1">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <span class="avatar-initial rounded bg-label-success"><i class="bx bx-cog"></i></span>
                                                </div>
                                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
                                            ...
                                            <li class="d-flex mb-4 pb-1">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <span class="avatar-initial rounded bg-label-success"><i class="bx bx-bolt"></i></span>
                                                </div>
                                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
                                            ...
                                            <li class="d-flex">
                                                ...
                                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="badge bg-label-info rounded-pill">Complete</div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <li class="d-flex mb-4 pb-1">
                                                ...
                                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                    <div class="me-2">
                                                        ...
                                                        <small>All components checked - no defects found</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="d-flex mb-4 pb-1">
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                <div class="copyright">
                                    <p>&copy; 2025 Absolute Safety. All Rights Reserved. | Designed with ❤️ for Industrial Safety</p>
                                </div>
                            </div>
