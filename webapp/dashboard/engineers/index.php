...
checkDashboardAccess('engineers');
...
<head>
  ...
  <title>Engineers Dashboard - Absolute Safety</title>
                  ...
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        ...
                        <a href="javascript:;" class="btn btn-sm btn-outline-primary">View Full
                          Report</a>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <ul class="list-unstyled">
                        <li class="d-flex mb-2">
                          <span class="badge bg-label-success me-2"><i
                              class="bx bx-check"></i></span>
                          <span>Follow manufacturer's scheduled maintenance</span>
                        </li>
                        <li class="d-flex mb-2">
                          <span class="badge bg-label-primary me-2"><i
                              class="bx bx-check"></i></span>
                ...
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    <div class="d-flex p-4 pt-3">
                      ...
                      <div>
                        <small class="text-muted d-block">Maharashtra Factories Rules
                          1963</small>
